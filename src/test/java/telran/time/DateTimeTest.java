...
public class DateTimeTest {
    ...
    void pastTemporalDateProximityTest() {
        ...
        assertEquals(LocalDate.of(2024, 8, 4), 
                LocalDate.of(2024, 8, 5).with(new PastTemporalDateProximity(dates)));
        assertEquals(LocalDate.of(2024, 8, 11), 
                LocalDate.of(2024, 8, 16).with(new PastTemporalDateProximity(dates)));
    }
}